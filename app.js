...
const starterInventory=[
  ...
  {"id":"stock-rantac-150","name":"Rantac 150","type":"Pharma/Brand","generic":"Ranitidine 150 mg","category":"Gastrointestinal","form":"Tablet","batch":"TR326073","expiry":"2026-05-01","stock":90,"minStock":0,"notes":"Photograph identifies Rantac 150 (ranitidine 150 mg). Pack appears expired; do not dispense/use. Verify regulatory status before any clinical use.","use":"Acid-peptic symptoms / gastric acid reduction; clinical use requires current regulatory verification.","dose":"Not added as an automatic prescribing dose; verify current approved use and product status."}
];
